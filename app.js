...
app.use('/3daction', require('./routes/action'));
app.use('/3dcomedy', require('./routes/comedy'));
app.use('/3ddocumentary', require('./routes/documentary'));
app.use('/3dwar', require('./routes/war'));
